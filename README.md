...
I've also added [fieldset](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/fieldset) elements that act as accordians for the "ChatGPT Response", "Code Editor", and "Output Web Application" and have included error information in red for the latter so one does not have to go hunting
